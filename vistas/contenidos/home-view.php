...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fab fa-dashcube fa-fw"></i> &nbsp; SISTEMA DE EMPRÉSTIMOS / EVANEI FREITAS(SAIRÚ)
    </h3>
...
<div class="full-box tile-container">
    ...
    <a href="<?php echo SERVERURL; ?>item-list/" class="tile">
        <div class="tile-tittle">Itens</div>
        <div class="tile-icon">
    ...
    <a href="<?php echo SERVERURL; ?>reservation-pending/" class="tile">
        <div class="tile-tittle">Empréstimos</div>
        <div class="tile-icon">
    ...
    <a href="<?php echo SERVERURL; ?>reservation-list/" class="tile">
        <div class="tile-tittle">Pagos / Finalizados</div>
        <div class="tile-icon">
    ...
    <a href="<?php echo SERVERURL; ?>company/" class="tile">
        <div class="tile-tittle">Empresa / PJ / CPF</div>
        <div class="tile-icon">
